...
namespace Prototype_1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            p1.Age = 15;
            p1.BirthDate = Convert.ToDateTime("2003-04-25");
            p1.Name = "Nuran Huseynova";
            p1.IdInfo = new IdInfo(925);
            ...
            p1.Age = 25;
            p1.BirthDate = Convert.ToDateTime("2003-05-09");
            p1.Name = "Huseyn";
            p1.IdInfo.IdNumber = 259;
